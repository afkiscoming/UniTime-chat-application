...
while($row = mysqli_fetch_assoc($sql))
{
    ...
    //trimming message if lenght is  more than 100
    (strlen($result) >100) ? $message = substr($result, 0 ,100).'...' : $message = $result;
    //you text
    ...
    $output .= '<a href="chat.php?user_id='.$row['usersUniqueId'].'">
                    <div class="content">
